...
const Index = () => {
  ...
  const objectives = siteContent.objectives.items;
  const targetAudience = siteContent.audience.items;
  ...
  const renderPartnerMarquee = (
    ...
    const marqueeDuration = `${items.length * 2.1}s`;
    ...
    return (
      <div className="relative overflow-hidden">
        ...
        <div
          className={`partner-marquee ${reverse ? "partner-marquee-reverse" : ""}`}
        ...
        >
          {marqueeItems.map((partner, index) => (
            ...
            >
              <Card className="group flex h-44 w-60 items-center justify-center rounded-xl border border-gray-200 bg-white p-6 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800">
                <div className="relative flex h-full w-full items-center justify-center">
                  <img
                    src={partner.logo}
                    alt={partner.name}
                    className="max-h-32 w-auto object-contain transition-transform duration-300 group-hover:scale-110 dark:invert"
                    loading="lazy"
                  />
                </div>
              </Card>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="gioi-thieu" className="scroll-mt-16 border-y border-blue-100 bg-white py-24 dark:bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="mb-4 text-base px-4 py-2">
                {siteContent.intro.badge}
              </Badge>
              <h2 className="text-4xl font-bold mb-6 text-foreground">
                {siteContent.intro.title}
              </h2>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                {siteContent.intro.description1}
              </p>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                {siteContent.intro.description2}
              </p>
              <Button variant="cta" size="lg">
                {siteContent.intro.ctaLabel}
      ...
      {/* Objectives Section */}
      <section id="muc-tieu" className="scroll-mt-16 border-y border-blue-100 bg-blue-50 py-24 dark:bg-blue-950/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 text-base px-4 py-2">
              {siteContent.objectives.badge}
            </Badge>
            <h2 className="text-4xl font-bold mb-6">{siteContent.objectives.title}</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              {siteContent.objectives.description}
            </p>
          </div>
      ...
      <section className="border-y border-blue-100 bg-white py-24 dark:bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 text-base px-4 py-2">
              {siteContent.audience.badge}
            </Badge>
      ...
      {/* Format Section */}
      <section className="border-y border-blue-100 bg-blue-50 py-24 dark:bg-blue-950/20">
        <div className="container mx-auto px-4">
      ...
      {/* Timeline Section */}
      <section id="lo-trinh" className="scroll-mt-16 border-y border-blue-100 bg-blue-50 py-24 dark:bg-blue-950/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
      ...
      {/* Benefits Section */}
      <section id="quyen-loi" className="scroll-mt-16 border-y border-blue-100 bg-white py-24 dark:bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
      ...
      {/* Partners Section */}
      <section id="doi-tac" className="scroll-mt-16 border-y border-blue-100 bg-white py-24 dark:bg-gray-950">
        <div className="container px-4">
          ...
          >
            <div className="inline-flex items-center space-x-3 bg-primary text-primary-foreground px-6 py-3 rounded-lg mb-6">
              ...
              <h3 className="text-2xl font-bold">{siteContent.partners.businessTitle}</h3>
            </div>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              {siteContent.partners.businessDescription}
            </p>
          </motion.div>
          ...
          >
            {renderPartnerMarquee(corporatePartners)}
          </motion.div>
          ...
          >
            <div className="inline-flex items-center space-x-3 bg-primary text-primary-foreground px-6 py-3 rounded-lg mb-6">
              ...
              <h3 className="text-2xl font-bold">{siteContent.partners.schoolTitle}</h3>
            </div>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              {siteContent.partners.schoolDescription}
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.1 }}
          >
            {renderPartnerMarquee(educationPartners, true)}
          </motion.div>
        </div>
      </section>

      {/* CTA Section */}
      <section id="dang-ky" className="scroll-mt-16 py-24 hero-gradient">
          ...
          <div className="max-w-4xl mx-auto text-white">
            ...
            <div className="mt-8 flex justify-center items-center space-x-8 text-sm opacity-75">
              <div className="flex items-center">
                ...
                {siteContent.cta.highlights[0] ?? ""}
              </div>
              <div className="flex items-center">
                <Users className="h-4 w-4 mr-1" />
                {siteContent.cta.highlights[1] ?? ""}
              </div>
              <div className="flex items-center">
                <Clock className="h-4 w-4 mr-1" />
                {siteContent.cta.highlights[2] ?? ""}
              </div>
            </div>
          </div>
        </div>
